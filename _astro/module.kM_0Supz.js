...
`;function Ut(t){const e=X.useRef(null),n=X.useRef(null);return n.current&&n.current.update(t),X.useEffect(()=>(n.current=new ae({...t,ref:e}),()=>{n.current=null}),[]),tt.createElement("div",{ref:e})}export{Ut as default};
